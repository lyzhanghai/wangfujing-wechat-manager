...
<script src="${ctx}/notebook/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.js" type="text/javascript"></script>
<script type="text/javascript"> 
var data = new Array();
var xtext =  new Array();
var ins = [1,2,3];
var chart;
function lineGraph(){//柱形图初始化  
...
$(function(){
	...
	$.ajax({//获取获取用户增减数据   列表展示
		url : "/notebook/statistics/getUserSummary.json",
		type : "POST",
		dataType : "json",
	...
	$("#user_attr").click(function(){//用户属性页面
		$.ajax({
    		url : "/notebook/statistics/userAttribute.json",
    		type : "POST",
    		dataType : "html",
    		success : function(response){
    			$("#body").html(response);
														...
														<div class="ui_trendgrid_item">
															...
															<dl>
																...
																<dd class="ui_trendgrid_number">
																	<strong id=new_user>${new_user}</strong><em class="ui_trendgrid_unit"></em>
																</dd>
																<dd>日 &nbsp;&nbsp;&nbsp;--</dd>
																<dd>周 &nbsp;&nbsp;&nbsp;--</dd>
																<dd>月 &nbsp;&nbsp;&nbsp;--</dd>
													...
													<td>
														<div class="ui_trendgrid_item">
															...
															<dl>
																...
																<dd class="ui_trendgrid_number">
																	<strong>${cancel_user}</strong><em class="ui_trendgrid_unit"></em>
																</dd>
																<dd>日 &nbsp;&nbsp;&nbsp;--</dd>
																<dd>周 &nbsp;&nbsp;&nbsp;--</dd>
																<dd>月 &nbsp;&nbsp;&nbsp;--</dd>
													...
													<td>
														<div class="ui_trendgrid_item">
															...
															<dl>
																...
																<dd class="ui_trendgrid_number">
																	<strong>${new_user}</strong><em class="ui_trendgrid_unit"></em>
																</dd>
																<dd>日 &nbsp;&nbsp;&nbsp;--</dd>
																<dd>周 &nbsp;&nbsp;&nbsp;--</dd>
																<dd>月 &nbsp;&nbsp;&nbsp;--</dd>
									...
									<div class="pagination" id="wxPagebar_1480993432840">
										<span class="page_nav_area"> <a
											...
											class="btn page_prev" style="display: none;"><i
												...
												<span class="num_gap">/</span> <label>3</label>
