...
//    private RedisUtil redisUtil;
   ...
   /* public String tokenInit(String appid, String secret) {
        ...
        try {
           // jsontoken = com.wfj.util.HttpUtil.sendGet(com.wfj.util.Constants.ACCESSTOKENURL, params);
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//        accessToken = redisUtil.getKey(appid, "0000");
  ...
  /*  public MemberInfo Openid_userinfo(String openid, String appid, String secret) throws Exception {
        ...
        logger.info(params);
        String subscribers = com.wfj.util.HttpUtil.sendGet(com.wfj.util.Constants.OPENIDUSERINFOURL, params);
   ...
   /* public AccessTokenDto getOpenId(String appid, String secret, String code) {
        ...
        try {
            String openIdInfo = com.wfj.util.HttpUtil.sendGet(com.wfj.util.Constants.GETOPENIDURL, params);
